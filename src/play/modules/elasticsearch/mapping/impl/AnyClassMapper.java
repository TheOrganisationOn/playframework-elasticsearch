 ...
 *            the model type
 */
public class AnyClassMapper<M> implements ModelMapper<M> {
	...
	public AnyClassMapper(MapperFactory factory, Class<M> clazz, String indexPrefix) {
	 ...
	 */
	private static final <M> List<FieldMapper<M>> getMapping(MapperFactory factory,
			Class<M> clazz) {
